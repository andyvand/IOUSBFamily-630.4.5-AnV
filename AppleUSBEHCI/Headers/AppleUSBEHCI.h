...
protected:
    ...
    // Default value of AlwaysHardBIOSReset key
	bool									_alwaysHardBIOSReset;
...
public:
    ...
    IOReturn UIMAllocDev(UInt8 devAddr, UInt8 devSpd);
    IOReturn UIMPassEPDesAddr(UInt8 address, struct Endpoint *pEP);
