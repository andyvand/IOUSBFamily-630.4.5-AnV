...
void
AppleUSBEHCI::printAsyncQueue(int level, const char* __unused str, bool printSkipped, bool printTDs)
{
...
void
AppleUSBEHCI::printInactiveQueue(int level, const char* __unused str, bool printSkipped, bool printTDs)
{
#pragma unused (printSkipped)
...
IOReturn
AppleUSBEHCI::ShowPeriodicBandwidthUsed(int __unused level, const char * __unused fromStr)
{
	int		frame;
