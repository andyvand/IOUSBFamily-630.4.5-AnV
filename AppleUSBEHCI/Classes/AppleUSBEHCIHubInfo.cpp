...
static SInt32
CompareSPEs(const AppleUSBEHCISplitPeriodicEndpoint *pSPE1, const AppleUSBEHCISplitPeriodicEndpoint *pSPE2, const AppleUSBEHCITTInfo * __unused forTT)
{
...
IOReturn
AppleUSBEHCITTInfo::ShowPeriodicBandwidthUsed(int __unused level, const char * __unused fromStr)
{
	int		frame;
...
IOReturn
AppleUSBEHCITTInfo::ShowHSSplitTimeUsed(int __unused level, const char * __unused fromStr)
{
	int		frame;
...
void
AppleUSBEHCITTInfo::print(int level, const char * __unused fromStr)
{
	int		i;
