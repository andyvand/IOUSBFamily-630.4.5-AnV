...
enum 
{
	...
	kXHCIMaxInterruptersMask = XHCIBitRange(8,18),   //Intel 7 chipset (was 16)
	kXHCIMaxInterruptersShift = XHCIBitRangePhase(8,18),
};
...
enum 
{
  ...
  kXHCIScratchpadRestore = kXHCIBit26,  
...
enum
{
	kXHCIAC64Bit = kXHCIBit0, //64-bit Addressing Capability
  kXHCIBNC = kXHCIBit1,     //BW Negotiation Capability
	kXHCICSZBit = kXHCIBit2,  //Context Size
	kXHCIPPCBit = kXHCIBit3,  //Port Power Control
  kXHCIPIND = kXHCIBit4,    //Port Indicators
  kXHCILHRC = kXHCIBit5,    //Light Host Controller Reset is supported
  kXHCILTC  = kXHCIBit6,    //Latency Tolerance Messaging Capability
  kXHCINSS  = kXHCIBit7,    //No Secondary SID Support
...
enum 
{
	...
	kXHCICMDINTE = kXHCIBit2,   //Interrupter Enable
  kXHCICMDHSEE = kXHCIBit3,   //Host System Error Enable
  kXHCICMDLHCRST = kXHCIBit7, //Light Host Controller Reset
	kXHCICMDCSS = kXHCIBit8,    //Controller Save State
	kXHCICMDCRS = kXHCIBit9,    //Controller Restore State
	kXHCICMDEWE = kXHCIBit10,   //Enable Wrap Event
  kXHCICMDEU3S = kXHCIBit11,  //Enable U3 MFINDEX Stop
};
...
enum 
{
  ...
  kXHCIHSEBit = kXHCIBit2,  //Host System Error
	kXHCIEINT = kXHCIBit3,    //Event Interrupt
  kXHCIPCD = kXHCIBit4,     //Port Change Detect
	kXHCISSS = kXHCIBit8,     //Save State Status
	kXHCIRSS = kXHCIBit9,     //Restore State Status
	kXHCISRE = kXHCIBit10,    //Save/Restore Error
  kXHCICNR = kXHCIBit11,    //Controller Not Ready
  kXHCIHCE = kXHCIBit12,    //Host Controller Error 
};
...
enum 
{
	kXHCI_RCS = kXHCIBit0,    //Ring Cycle State
	kXHCI_CS  = kXHCIBit1,    //Command Stop
	kXHCI_CA  = kXHCIBit2,    //Command Abort
	kXHCI_CRR  = kXHCIBit3,   //Command Ring Running
...
enum 
{
	kXHCIPortSC_CCS = kXHCIBit0, /* RO - current connect status */
	kXHCIPortSC_PED = kXHCIBit1, /* RW1C - port enabled / disabled */
	kXHCIPortSC_Rsvd1 = kXHCIBit2,
	kXHCIPortSC_OCA = kXHCIBit3, /* RO - over current active */
	kXHCIPortSC_PR = kXHCIBit4,  /* RW1S - port reset */

	kXHCIPortSC_LinkState_Mask = XHCIBitRange(5, 8),
	kXHCIPortSC_LinkState_Shift = XHCIBitRangePhase(5, 8),

	kXHCIPortSC_PP = kXHCIBit9,  /* RW - port power */
	...
	kXHCIPortSC_LWS = kXHCIBit16, /* RW1S - port link state write strobe */
	kXHCIPortSC_CSC = kXHCIBit17, /* RW1C - connect status change */
	kXHCIPortSC_PEC = kXHCIBit18, /* RW1C - port enable/disable change */
	kXHCIPortSC_WRC = kXHCIBit19, /* RW1C - warm port reset change (RsvdZ for USB2 ports) */
	kXHCIPortSC_OCC = kXHCIBit20, /* RW1C - over-current change */
	kXHCIPortSC_PRC = kXHCIBit21, /* RW1C - port reset change */
	kXHCIPortSC_PLC = kXHCIBit22, /* RW1C - port link state change */
	kXHCIPortSC_CEC = kXHCIBit23, /* RW1C - config error change (RsvdZ for USB2 ports) */
	kXHCIPortSC_CAS = kXHCIBit24, /* RO - cold attach status */
	kXHCIPortSC_WCE = kXHCIBit25, /* RW - wake on connect enable */
	kXHCIPortSC_WDE = kXHCIBit26, /* RW - wake on disconnect enable */
	kXHCIPortSC_WOE = kXHCIBit27, /* RW - wake on over-current enable */

	kXHCIPortSC_DR = kXHCIBit30, /* RO - device removable */
	kXHCIPortSC_WPR = kXHCIBit31, /* RW1S - warm port reset (RsvdZ for USB2 ports) */
...
enum 
{
	...
	kXHCIPortMSC_RWE = kXHCIBit3,     //Remote Wake Enable RW
	...
	kXHCIPortMSC_HLE = kXHCIBit16,        //Hardware LPM Enable RO 
