...
IOReturn 
AppleUSBXHCI::CheckPeriodicBandwidth(int slotID, int __unused endpointIdx, UInt16 maxPacketSize, short interval, int __unused epType, UInt8 __unused maxStream, UInt8 maxBurst, UInt8 mult)
{
