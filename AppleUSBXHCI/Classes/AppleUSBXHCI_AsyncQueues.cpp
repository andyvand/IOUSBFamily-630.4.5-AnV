...
void
AppleXHCIAsyncTransferDescriptor::print(int __unused level)
{
...
void 
AppleXHCIAsyncEndpoint::validateLists(int __unused level)
{
...
void
AppleXHCIAsyncEndpoint::print(int __unused level)
{
