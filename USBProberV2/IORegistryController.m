    ...
    if (CFGetTypeID(value) == CFStringGetTypeID()) {
        ...
        switch (CFNumberGetType((CFNumberRef)value)) {
            ...
            case kCFNumberSInt64Type:
                ...
                break;
            default:
                 aNewNode = [[IORegDetailOutlineViewNode alloc] initWithName:(NSString *)key value:[NSString stringWithFormat:@"%@ (0x%x)",[value description], (unsigned int)[value intValue]]];
        }
