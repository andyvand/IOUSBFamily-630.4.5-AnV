...
#include "../../IOUSBFamily/Headers/USBHub.h"
#include "../../IOUSBFamily/Headers/IOUSBHubDevice.h"
...
//================================================================================================
IOReturn 
AppleUSBHubPort::init( AppleUSBHub *parent, int portNum, UInt32 powerAvailable, bool captive, bool hasExternalConnector, bool muxed, char * __unused methodName )
{
    _hub						= parent;
    _bus						= parent->_bus;
...
IOReturn 
AppleUSBHubPort::DefaultBHResetChangeHandler(UInt16 __unused changeFlags, UInt16 __unused statusFlags)
{
...
{
    _portStatus.statusFlags = statusFlags;
    _portStatus.changeFlags = changeFlags;
