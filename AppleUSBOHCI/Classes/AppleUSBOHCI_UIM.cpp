...
void 
AppleUSBOHCI::printTD(AppleOHCIGeneralTransferDescriptorPtr pTD, int __unused level)
{
    UInt32 w0, dir;
...
void 
AppleUSBOHCI::printED(AppleOHCIEndpointDescriptorPtr pED, int __unused level)
{
    UInt32 w0, dir;
...
void 
AppleUSBOHCI::print_td(AppleOHCIGeneralTransferDescriptorPtr pTD, int __unused level)
{
    UInt32 w0, dir, err;
...
void 
AppleUSBOHCI::print_itd(AppleOHCIIsochTransferDescriptorPtr pTD, int __unused level)
{
    UInt32 w0, err;
    int i;
    if (pTD == 0) return;
...
IOReturn
AppleUSBOHCI::UIMEnableAllEndpoints(bool __unused enable)
{
    AppleOHCIEndpointDescriptorPtr	pEDQueue;
	UInt32							edFlags;
	int								i;
