...
IOUSBMassStorageClass::start ( IOService * provider )
{
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kAtUSBAddress ),
							(unsigned int)(UInt64)this, ( unsigned int ) GetInterfaceReference()->GetDevice()->GetAddress(),
							NULL, NULL );
	...
	else
	{
		...
		RecordUSBTimeStamp ( UMC_TRACE ( kIOUMCStorageCharacDictFound ),
							 (unsigned int)(UInt64)this, NULL, NULL, NULL );
...
IOUSBMassStorageClass::message ( UInt32 type, IOService * provider, void * argument )
{
	...
	RecordUSBTimeStamp ( UMC_TRACE ( kMessagedCalled ), (unsigned int)(UInt64)this, type, NULL, NULL );
										...
										IOOptionBits    options )
{
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kWillTerminateCalled ),
							(unsigned int)(UInt64)this, (unsigned int)(UInt64)GetInterfaceReference(),
...
IOUSBMassStorageClass::didTerminate ( IOService * provider, IOOptionBits options, bool * defer )
{
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kDidTerminateCalled ),
						(unsigned int)(UInt64)this, ( unsigned int ) fTerminationDeferred, NULL, NULL );
...
IOUSBMassStorageClass::BeginProvidedServices ( void )
{
        ...
        if ( characterDict != NULL )
        {
            ...
            if( maxLUN != NULL )
            {
                ...
                RecordUSBTimeStamp (	UMC_TRACE ( kBOPreferredMaxLUN ),
                                        (unsigned int)(UInt64)this, maxLUN->unsigned8BitValue(), NULL, NULL );
		...
		if( maxLUNDetermined == false )
		{
			...
			while ( status != kIOReturnSuccess )
			{
				...
				RecordUSBTimeStamp (	UMC_TRACE ( kBOGetMaxLUNReturned ),
										(unsigned int)(UInt64)this, status, fMaxLogicalUnitNumber, ( unsigned int ) triedReset );
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kLUNConfigurationComplete ),
							(unsigned int)(UInt64)this, GetMaxLogicalUnitNumber ( ), NULL, NULL );
									...
									SCSITaskStatus *			taskStatus )
{
	...
	*serviceResponse =  kSCSIServiceResponse_Request_In_Process;
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kCDBLog1 ),
							(unsigned int)(UInt64)this, (unsigned int)(UInt64)request,
   	...
   	if ( GetInterfaceProtocol() == kProtocolBulkOnly )
	{
		...
		RecordUSBTimeStamp (	UMC_TRACE ( kBOSendSCSICommandReturned ),
								(unsigned int)(UInt64)this, (unsigned int)(UInt64)request, status, NULL );
...
IOUSBMassStorageClass::CompleteSCSICommand ( SCSITaskIdentifier request, IOReturn status )
{
	...
	else
	{
		...
		RecordUSBTimeStamp ( UMC_TRACE ( kCompletingCommandWithError ), (unsigned int)(UInt64)this, NULL, NULL, NULL );
...
IOUSBMassStorageClass::AbortSCSICommand ( SCSITaskIdentifier abortTask )
{
	...
	RecordUSBTimeStamp (	UMC_TRACE( kAbortedTask ),
							(unsigned int)(UInt64)this, (unsigned int)(UInt64)abortTask, NULL, NULL );
								...
								IOUSBCompletion	*	completion ) 
{
	...
	RecordUSBTimeStamp ( UMC_TRACE ( kGetEndPointStatus ),
						 (unsigned int)(UInt64)this, status,
	...
	if ( GetInterfaceProtocol ( ) == kProtocolBulkOnly )
	{
		...
		if ( fBulkOnlyCommandStructInUse == true  )
		{
			...
			RecordUSBTimeStamp (	UMC_TRACE ( kBOCommandAlreadyInProgress ),
								(unsigned int)(UInt64)this, (unsigned int)(UInt64)request, NULL, NULL );
			goto Exit;
...
IOUSBMassStorageClass::HandlePowerOn ( void )
{
	...
	{   
		...
		RecordUSBTimeStamp ( UMC_TRACE ( kHandlePowerOnUSBReset ), (unsigned int)(UInt64)this, NULL, NULL, NULL );
...
IOUSBMassStorageClass::sResetDevice ( void * refcon )
{
		 ...
		 ( driver->isInactive ( ) == true ) )
	{
		...
		RecordUSBTimeStamp ( UMC_TRACE ( kUSBDeviceResetWhileTerminating ), (unsigned int)(UInt64)driver,
    ...
    RecordUSBTimeStamp ( UMC_TRACE ( kDeviceInformation ), (unsigned int)(UInt64)driver, status, deviceInfo, NULL );
		 ...
		 ( ( ( deviceInfo & kUSBInformationDeviceIsEnabledMask ) == 0 ) && ( ( deviceInfo & kUSBInformationDeviceIsInternalMask ) == 0 ) ) )
	{
		...
		RecordUSBTimeStamp ( UMC_TRACE ( kUSBDeviceResetAfterDisconnect ), (unsigned int)(UInt64)driver, NULL, NULL, NULL );
		goto ErrorExit;
	...
	RecordUSBTimeStamp ( UMC_TRACE ( kUSBDeviceResetReturned ), (unsigned int)(UInt64)driver, status, NULL, NULL );
...
IOUSBMassStorageClass::ClearPipeStall( void )
{
	...
	RecordUSBTimeStamp (	UMC_TRACE ( kClearEndPointStall ), (unsigned int)(UInt64)this, status,
...
IOUSBMassStorageClass::AbortCurrentSCSITask ( void )
{
	...
	if ( currentTask != NULL )
	{
		...
		RecordUSBTimeStamp (	UMC_TRACE( kAbortCurrentSCSITask ),
							(unsigned int)(UInt64)this, (unsigned int)(UInt64)currentTask, (unsigned int)(UInt64) fDeviceAttached, (unsigned int)(UInt64)fConsecutiveResetCount );
		...
		RecordUSBTimeStamp (	UMC_TRACE ( kCompleteSCSICommand ),
							(unsigned int)(UInt64)this, (unsigned int)(UInt64)currentTask,
...
Exit:
    ...
    RecordUSBTimeStamp ( UMC_TRACE ( kSuspendPort ), (unsigned int)(UInt64)this, status, suspend, NULL );
